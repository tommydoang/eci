...
public class Tab8ViewModel extends BaseViewModel<Tab8Navigator> {

    private List<DataProductTab8Response> productsList = new ArrayList<>();
    private List<DataBannerTab8Response> bannerList = new ArrayList<>();
    private final MutableLiveData<List<DataProductTab8Response>> tab8Data;
    private final ObservableList<DataProductTab8Response> tab8DataList = new ObservableArrayList<>();

    public Tab8ViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        super(dataManager, schedulerProvider);
        tab8Data = new MutableLiveData<>();
        getDataFromServer();
    }

    public MutableLiveData<List<DataProductTab8Response>> getImageLiveDataList() {
        return tab8Data;
    }

    public ObservableList<DataProductTab8Response> getTab8DataList() {
        return tab8DataList;
    }

    public void setDataToList(List<DataProductTab8Response> dataListApi){
        tab8DataList.clear();
        tab8DataList.addAll(dataListApi);
    }

    public List<DataBannerTab8Response> getAllBannerList(){
        return bannerList;
    }
    ...
    private void setProductModel(JSONArray jsonArray){
        try{
            ...
            for (int idx = 0; idx < jsonSize; idx++){
                ...
                if (object.getString("id_category_head").equals("7")) {
...
//                        Log.d("longDesc tes1 2", objProd.getString("long_desc"));
            ...
            tab8Data.setValue(productsList);
        ...
        try{
            ...
            if (objResponseSize > 0) {
                for (int idx = 0; idx < objResponseSize; idx++) {
                    ...
                    if (subObjResponse.getString("meta_title").equals("7")) {
                        DataBannerTab8Response dbr = new DataBannerTab8Response();
