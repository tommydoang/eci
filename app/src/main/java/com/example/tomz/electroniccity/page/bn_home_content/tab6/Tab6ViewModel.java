...
public class Tab6ViewModel extends BaseViewModel<Tab6Navigator> {

    private List<DataProductTab6Response> productsList = new ArrayList<>();
    private List<DataBannerTab6Response> bannerList = new ArrayList<>();
    private final MutableLiveData<List<DataProductTab6Response>> tab6Data;
    private final ObservableList<DataProductTab6Response> tab6DataList = new ObservableArrayList<>();

    public Tab6ViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        super(dataManager, schedulerProvider);
        tab6Data = new MutableLiveData<>();
        getDataFromServer();
    }

    public MutableLiveData<List<DataProductTab6Response>> getImageLiveDataList() {
        return tab6Data;
    }

    public ObservableList<DataProductTab6Response> getTab6DataList() {
        return tab6DataList;
    }

    public void setDataToList(List<DataProductTab6Response> dataListApi){
        tab6DataList.clear();
        tab6DataList.addAll(dataListApi);
    }

    public List<DataBannerTab6Response> getAllBannerList(){
        return bannerList;
    }
    ...
    private void setProductModel(JSONArray jsonArray){
        try{
            ...
            for (int idx = 0; idx < jsonSize; idx++){
                ...
                if (object.getString("id_category_head").equals("5")) {
...
//                        Log.d("skuProd tes1 tab2", objProd.getString("sku"));
                        ...
                        DataProductTab6Response dpr = new DataProductTab6Response();
...
//                        Log.d("longDesc tes1 2", objProd.getString("long_desc"));
            ...
            tab6Data.setValue(productsList);
        ...
        try{
            ...
            if (objResponseSize > 0) {
                for (int idx = 0; idx < objResponseSize; idx++) {
                    ...
                    if (subObjResponse.getString("meta_title").equals("5")) {
                        DataBannerTab6Response dbr = new DataBannerTab6Response();
