...
public class Tab7ViewModel extends BaseViewModel<Tab7Navigator> {

    private List<DataProductTab7Response> productsList = new ArrayList<>();
    private List<DataBannerTab7Response> bannerList = new ArrayList<>();
    private final MutableLiveData<List<DataProductTab7Response>> tab7Data;
    private final ObservableList<DataProductTab7Response> tab7DataList = new ObservableArrayList<>();

    public Tab7ViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        super(dataManager, schedulerProvider);
        tab7Data = new MutableLiveData<>();
        getDataFromServer();
    }

    public MutableLiveData<List<DataProductTab7Response>> getImageLiveDataList() {
        return tab7Data;
    }

    public ObservableList<DataProductTab7Response> getTab7DataList() {
        return tab7DataList;
    }

    public void setDataToList(List<DataProductTab7Response> dataListApi){
        tab7DataList.clear();
        tab7DataList.addAll(dataListApi);
    }

    public List<DataBannerTab7Response> getAllBannerList(){
        return bannerList;
    }
    ...
    private void setProductModel(JSONArray jsonArray){
        try{
            ...
            for (int idx = 0; idx < jsonSize; idx++){
                ...
                if (object.getString("id_category_head").equals("6")) {
...
//                        Log.d("skuProd tes1 tab2", objProd.getString("sku"));
                        ...
                        DataProductTab7Response dpr = new DataProductTab7Response();
...
//                        Log.d("longDesc tes1 2", objProd.getString("long_desc"));
            ...
            tab7Data.setValue(productsList);
        ...
        try{
            ...
            if (objResponseSize > 0) {
                for (int idx = 0; idx < objResponseSize; idx++) {
                    ...
                    if (subObjResponse.getString("meta_title").equals("6")) {
                        DataBannerTab7Response dbr = new DataBannerTab7Response();
