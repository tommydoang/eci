package com.example.tomz.electroniccity.adapter.tab4;
...
public class Tab4AllSubCategoryAdapter extends BaseAdapter {

    private Context ctx;
    private ArrayList<Tab4AllSubCategoryModel> tab4AllSubCategoryModels;

    public Tab4AllSubCategoryAdapter(Context ctx,
                                     ArrayList<Tab4AllSubCategoryModel> tab4AllSubCategoryModels) {
        this.ctx = ctx;
        this.tab4AllSubCategoryModels = tab4AllSubCategoryModels;
    }

    @Override
    public int getCount() {
        return tab4AllSubCategoryModels.size();
    }

    @Override
    public Object getItem(int position) {
        return tab4AllSubCategoryModels.get(position);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view==null) {
            view= LayoutInflater.from(ctx).inflate(R.layout.tab4_all_sub_category,viewGroup,false);
        }

        final Tab4AllSubCategoryModel s= (Tab4AllSubCategoryModel) this.getItem(i);
